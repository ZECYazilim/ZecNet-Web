...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.BankaHesaplar.BankaHesap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Bankalar.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Faturalar.FaturaHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Hizmetler.Hizmet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Makbuzlar.Makbuz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Makbuzlar.MakbuzHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Masraflar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZecNet.OnMuhasebe.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.Bankalar.Banka", "Banka")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Faturalar.Fatura", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.Cariler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ZecNet.OnMuhasebe.Donemler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZecNet.OnMuhasebe.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Makbuzlar.Makbuz", b =>
                {
                    b.HasOne("ZecNet.OnMuhasebe.BankaHesaplar.BankaHesap", "BankaHesap")
                        .WithMany("Makbuzlar")
                    ...
                    b.HasOne("ZecNet.OnMuhasebe.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("ZecNet.OnMuhasebe.Bankalar.Banka", "CekBanka")
                        .WithMany("MakbuzHareketler")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ZecNet.OnMuhasebe.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketler")
                    ...
                    b.HasOne("ZecNet.OnMuhasebe.Makbuzlar.Makbuz", "Makbuz")
                        .WithMany("MakbuzHareketler")
            ...
            modelBuilder.Entity("ZecNet.OnMuhasebe.Parametreler.FirmaParametre", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("ZecNet.OnMuhasebe.Parametreler.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
